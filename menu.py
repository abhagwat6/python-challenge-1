...
while place_order:
    ...
    while True:
        ...
        if keep_ordering.lower() == "y":
            # Tell the customer that they can keep ordering
            place_order = True
            ...
            break   
                ...
                # their order
            print("You selected wrong item number")  
                # Exit the keep ordering question loop
            break   
